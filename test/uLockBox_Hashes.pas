...
begin
  ...
  FReferenceTestRefrnc := AnsiBytesOf('248D6A61 D20638B8 ' + 'E5C02693 0C3E6039 A33CE459 64FF2167 F6ECEDD4 19DB06C1');
...
{$WARNINGS ON}
  ...
  FHash.Burn;
  Check(CompareMemoryStreams(FRefValue, FTestValue), Format('Hash %s failed it''s standard reference test.', [FHash.Hash]))
end;
...
begin
  ...
  FReferenceTestRefrnc := AnsiBytesOf('8E959B75 DAE313DA 8CF4F728 14FC143F ' +
    '8F7779C6 EB9F7FA1 7299AEAD B6889018 501D289E 4900F7E4 ' + '331B99DE C4B5433A C7D329EE B6DD2654 5E96E55B 874BE909');
  ReferenceTestVectors
end;
