...
begin
  ...
  try
    Check((Rand.BitLength <= 201) and (Rand.BitLength >= 100), 'HugeCardinal Create Random failed.')
  finally
    Rand.Free
  end
end;
...
begin
  ...
  Check(F100.isSmall and (F100.ExtractSmall = 100), 'HugeCardinal CreateSmall failed.')
end;
...
begin
  ...
  Check(Temp2000_1.isSmall and (Temp2000_1.ExtractSmall = 47), 'HugeCardinal AddMod failed.')
end;
...
begin
  ...
  // check x = y
  Temp2000_1.Assign(Fbig1234);
  Check(Temp2000_1.Compare(Fbig1234) = rEqualTo, 'Huge Cardinal Assign failed.')
end;
...
begin
  ...
  Check(Temp2000_1.isSmall and (Temp2000_1.ExtractSmall = 10000), 'HugeCardinal AssignSmall failed.')
end;
...
begin
  ...
  Check(Temp2000_1.isSmall and (Temp2000_1.ExtractSmall = 44), 'THugeCardinal.ExtactSmall/isSmall failed.')
end;
...
begin
  ...
  Check(Temp2000_1.Compare(Temp2000_2) = rEqualTo, 'THugeCardinal Increment failed.')
end;
...
begin
  ...
  Check(T3.isSmall and (T3.ExtractSmall = 234), 'THugeCardinal Modulo failed.')
end;
...
begin
  for Method := False to True do
    begin
      ...
      Check(Temp2000_1.Compare(Temp2000_2) = rEqualTo, 'THugeCardinal MulPower2 failed - subtest 1.');

      Temp2000_1.Assign(Fbig1234);
      Temp2000_1.MulPower2(88);
      Temp2000_1.MulPower2(-88);
      Check(Temp2000_1.Compare(Fbig1234) = rEqualTo, 'THugeCardinal MulPower2 failed - subtest 1.');
      ...
      s := Format('%x', [Temp2000_1.ExtractSmall]);
      Check(Temp2000_1.Compare(Temp2000_2) = rEqualTo, 'THugeCardinal MulPower2 failed - subtest 3.')
    end
end;
...
begin
  ...
  Check(Temp2000_1.Compare(Temp2000_2) = rEqualTo, 'THugeCardinal MulSmall failed.');
end;
...
begin
  ...
  Check(Temp2000_1.Compare(Fbig1234) = rEqualTo, 'THugeCardinal Subtract failed.');
end;
...
begin
  ...
  Check(T3.Compare(Fbig3547) = rEqualTo, 'THugeCardinal Multiply failed (10^33 * 10^44 = 10^77).');
  FreeAndNil(T3)
end;
...
begin
  ...
  Check(Fbig1234.CompareSmall(42) = rEqualTo, 'THugeCardinal MultiplyMod failed.');
end;
...
begin
  ...
  Check(Fbig1234.CompareSmall(9) = rEqualTo, 'THugeCardinal PowerMod failed (6529 ^ 2987 mod 100 = 9).')
end;
...
begin
  ...
  T3.Resize(200);
  Check(T3.CapacityInBits = 200, 'THugeCardinal Resize failed .');
  FreeAndNil(T3)
end;
...
begin
  ...
  Check(Fbig1234.CompareSmall(9) = rEqualTo, 'THugeCardinal SmallExponent_PowerMod failed (6529 ^ 2987 mod 100 = 9).')
end;
...
begin
  ...
  for Order := LittleEndien to BigEndien do
    begin
      ...
      Check(Fbig1234.Compare(Fbig2313) = rEqualTo, 'THugeCardinal Test_StreamOut failed.')
    end
end;
