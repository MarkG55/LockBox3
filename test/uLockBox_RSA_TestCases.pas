...
type
  ...
  protected
    ...
    procedure OnProgress(Sender: TObject; BitsProcessed, TotalBits: int64;
      var doAbort: boolean);
    procedure CheckPowerModWithCRT(m, d, n, p, q, dp, dq, qinv: THugeCardinal;
      const Msg: string);
...
procedure TRSA_TestCase.OnProgress(Sender: TObject; BitsProcessed, TotalBits: int64; var doAbort: boolean);
begin
...
begin
  ...
  for j := 1 to 3 do
    begin
      Count1 := 0;
      Compute_RSA_Fundamentals_2Factors(480, StandardExponent, n, e, d, Totient,
        p, q, dp, dq, qinv, nil, nil, 20, FPool, Count1, FwasAborted);
...
begin
  ...
  Count1 := 0;
  Compute_RSA_Fundamentals_2Factors(512, StandardExponent, n, e, d, Totient, p,
    q, dp, dq, qinv, OnProgress, nil, 20, FPool, Count1, FwasAborted);
...
procedure TRSA_TestCase.CheckPowerModWithCRT(m, d, n, p, q, dp, dq, qinv: THugeCardinal; const Msg: string);
var
  m1, m2: THugeCardinal;
begin
  m1 := m.Clone;
...
var
  ...
  function MakeHuge(const Definition: TBytes; BitLen: cardinal): THugeCardinal;
  begin
    Tmp.Size := 0;
...
begin
  ...
  try
    ...
    Check(CompareMemoryStreams(Plaintext, Recon), 'RSAES_OAEP_ENCRYPT/RSAES_OAEP_DECRYPT general inversion test failed!')
...
begin
  ...
  try
    case Codec.AsymetricKeySizeInBits of
      512:
        s := RSA_512_SampleKey1;
      1024:
        s := RSA_1024_SampleKey1;
    else
      Check(False, 'No test case yet for this key size.');
    end;
