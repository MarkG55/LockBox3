...
type
  ...
  protected
    ...
    procedure Generic_Signatory_InversionTests(Seed: uint64 { =-1 for random };
      DocumentSize, KeyFormatVersion: integer);
...
procedure TRSASignatory_TestCase.Generic_Signatory_InversionTests(Seed: uint64; DocumentSize, KeyFormatVersion: integer);
begin
  if Seed = -1 then
    FRand.Randomize
  else
...
function TRSASignatory_TestCase.OnProgress(Sender: TObject;
