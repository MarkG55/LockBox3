...
function TCFB_8Bit.Chain_DecryptBlock(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec)
  : TBlockChainLink;
begin
  result := TCFB_8BitLink.Create(Key, InitializationVector, Cipher)
end;

function TCFB_8Bit.Chain_EncryptBlock(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec)
  : TBlockChainLink;
begin
  result := TCFB_8BitLink.Create(Key, InitializationVector, Cipher)
end;
...
begin
  result := 'http://csrc.nist.gov/publications/nistpubs/800-38a/sp800-38a.pdf' + '|section 6.3'
end;
...
constructor TCFB_8BitLink.Create(Key1: TSymetricKey; IV1: TMemoryStream; Cipher1: IBlockCodec);
begin
