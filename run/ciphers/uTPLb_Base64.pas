...
type
  ...
  TBase64Converter = class(TInterfacedObject, IStreamCipher, ICryptoGraphicAlgorithm, IisBase64Converter)
  private
...
type
  TBase64Conv = class(TInterfacedObject, IStreamEncryptor, IStreamDecryptor, IisBase64Converter)
  private
...
function TBase64Converter.Start_Decrypt(Key: TSymetricKey; PlainText: TStream): IStreamDecryptor;
begin
  result := TBase64Conv.Create(PlainText)
end;

function TBase64Converter.Start_Encrypt(Key: TSymetricKey; CipherText: TStream): IStreamEncryptor;
begin
