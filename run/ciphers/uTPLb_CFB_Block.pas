...
function TCFB_Block.Chain_DecryptBlock(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec)
  : TBlockChainLink;
begin
  result := TCFB_BlockLink.BaseCreate(Key, InitializationVector, Cipher)
end;

function TCFB_Block.Chain_EncryptBlock(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec)
  : TBlockChainLink;
begin
  result := TCFB_BlockLink.BaseCreate(Key, InitializationVector, Cipher)
end;
