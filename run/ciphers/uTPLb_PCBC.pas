...
type
  ...
  private
    ...
    constructor Create(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec);
...
function TPCBC.Chain_DecryptBlock(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec): TBlockChainLink;
begin
  result := TPCBCLink.Create(Key, InitializationVector, Cipher)
end;

function TPCBC.Chain_EncryptBlock(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec): TBlockChainLink;
begin
  result := TPCBCLink.Create(Key, InitializationVector, Cipher)
end;
...
constructor TPCBCLink.Create(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec);
begin
