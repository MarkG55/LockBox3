...
function TECB.Chain_DecryptBlock(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec): TBlockChainLink;
begin
  result := TECBLink.BaseCreate(Key, InitializationVector, Cipher)
end;

function TECB.Chain_EncryptBlock(Key: TSymetricKey; InitializationVector: TMemoryStream; const Cipher: IBlockCodec): TBlockChainLink;
begin
  result := TECBLink.BaseCreate(Key, InitializationVector, Cipher)
end;
...
begin
  result := 'http://csrc.nist.gov/publications/nistpubs/800-38a/sp800-38a.pdf' + '|section 6.1'
end;
