...
type
  ...
  TGenerateAsymetricKeyPairProgress = procedure(Sender: TObject; CountPrimalityTests: integer; var doAbort: boolean) of object;
  ...
  ICodec = interface
    ...
    property OnAsymGenProgress: TGenerateAsymetricKeyPairProgress read GetAsymGenProgressEvent write SetAsymGenProgressEvent;
