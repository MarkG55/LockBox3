...
{$IFEND}
  ...
  TSimpleBlockCipher = class(TInterfacedObject, IBlockCipher, ICryptoGraphicAlgorithm)
  private
  ...
  protected
    function Encrypt(const Buffer: TBytes; Key: TSimpleBlockCipherKey; doEncrypt: boolean): TBytes; virtual; abstract;
  ...
  public
    ...
    constructor Create(const ProgId1: string; const DisplayName1: string; Features1: TAlgorithmicFeatureSet;
...
constructor TSimpleBlockCipher.Create(const ProgId1, DisplayName1: string; Features1: TAlgorithmicFeatureSet;
  BlockSizeInBytes1: integer);
begin
  FProgId := ProgId1;
