...
{$IF compilerversion >= 21} [DesignDescription('SHA-2 is a family of hashes designed to supersede SHA-1. As of the date ' + 'of this writing, there are no discovered collisions for any SHA-2 member.')]
{$ENDIF}

  TSHA2 = class(TInterfacedObject, IHashDsc, ICryptoGraphicAlgorithm, IControlObject)
  private
...
const
  K_Values_32: array [0 .. 63] of uint32 = ($428A2F98, $71374491, $B5C0FBCF, $E9B5DBA5, $3956C25B, $59F111F1, $923F82A4, $AB1C5ED5,
    $D807AA98, $12835B01, $243185BE, $550C7DC3, $72BE5D74, $80DEB1FE, $9BDC06A7, $C19BF174, $E49B69C1, $EFBE4786, $0FC19DC6, $240CA1CC,
    $2DE92C6F, $4A7484AA, $5CB0A9DC, $76F988DA, $983E5152, $A831C66D, $B00327C8, $BF597FC7, $C6E00BF3, $D5A79147, $06CA6351, $14292967,
    $27B70A85, $2E1B2138, $4D2C6DFC, $53380D13, $650A7354, $766A0ABB, $81C2C92E, $92722C85, $A2BFE8A1, $A81A664B, $C24B8B70, $C76C51A3,
    $D192E819, $D6990624, $F40E3585, $106AA070, $19A4C116, $1E376C08, $2748774C, $34B0BCB5, $391C0CB3, $4ED8AA4A, $5B9CCA4F, $682E6FF3,
...
const
  K_Values_64: array [0 .. 79] of uint64 = ($428A2F98D728AE22, $7137449123EF65CD, $B5C0FBCFEC4D3B2F, $E9B5DBA58189DBBC,
    $3956C25BF348B538, $59F111F1B605D019, $923F82A4AF194F9B, $AB1C5ED5DA6D8118, $D807AA98A3030242, $12835B0145706FBE,
    $243185BE4EE4B28C, $550C7DC3D5FFB4E2, $72BE5D74F27B896F, $80DEB1FE3B1696B1, $9BDC06A725C71235, $C19BF174CF692694,
    $E49B69C19EF14AD2, $EFBE4786384F25E3, $0FC19DC68B8CD5B5, $240CA1CC77AC9C65, $2DE92C6F592B0275, $4A7484AA6EA6E483,
    $5CB0A9DCBD41FBD4, $76F988DA831153B5, $983E5152EE66DFAB, $A831C66D2DB43210, $B00327C898FB213F, $BF597FC7BEEF0EE4,
    $C6E00BF33DA88FC2, $D5A79147930AA725, $06CA6351E003826F, $142929670A0E6E70, $27B70A8546D22FFC, $2E1B21385C26C926,
    $4D2C6DFC5AC42AED, $53380D139D95B3DF, $650A73548BAF63DE, $766A0ABB3C77B2A8, $81C2C92E47EDAEE6, $92722C851482353B,
    $A2BFE8A14CF10364, $A81A664BBC423001, $C24B8B70D0F89791, $C76C51A30654BE30, $D192E819D6EF5218, $D69906245565A910,
    $F40E35855771202A, $106AA07032BBD1B8, $19A4C116B8D2D0C8, $1E376C085141AB53, $2748774CDF8EEB99, $34B0BCB5E19B48A8,
    $391C0CB3C5C95A63, $4ED8AA4AE3418ACB, $5B9CCA4F7763E373, $682E6FF3D6B2B8A3, $748F82EE5DEFB2FC, $78A5636F43172F60,
    $84C87814A1F0AB72, $8CC702081A6439EC, $90BEFFFA23631E28, $A4506CEBDE82BDE9, $BEF9A3F7B2C67915, $C67178F2E372532B,
    $CA273ECEEA26619C, $D186B8C721C0C207, $EADA7DD6CDE0EB1E, $F57D4F7FEE6ED178, $06F067AA72176FBA, $0A637DC5A2C898A6,
    $113F9804BEF90DAE, $1B710B35131C471B, $28DB77F523047D84, $32CAAB7B40C72493, $3C9EBE0A15C9BEBC, $431D67C49C100D4C,
    $4CC5D4BECB3E42B6, $597F299CFC657E2A, $5FCB6FAB3AD6FAEC, $6C44198C4A475817);

{$ELSE}
  // Delphi 7
const
  K_Values_64: array [0 .. 79] of uint64 = (
    { <UtoS_Cnvt> } uint64($428A2F98D728AE22) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($7137449123EF65CD) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$4A3F043013B2C4D1) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$164A245A7E762444) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($3956C25BF348B538) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($59F111F1B605D019) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$6DC07D5B50E6B065) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$54E3A12A25927EE8) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$27F855675CFCFDBE) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($12835B0145706FBE) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($243185BE4EE4B28C) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($550C7DC3D5FFB4E2) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($72BE5D74F27B896F) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$7F214E01C4E9694F) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$6423F958DA38EDCB) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$3E640E8B3096D96C) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$1B64963E610EB52E) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$1041B879C7B0DA1D) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($0FC19DC68B8CD5B5) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($240CA1CC77AC9C65) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($2DE92C6F592B0275) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($4A7484AA6EA6E483) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($5CB0A9DCBD41FBD4) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($76F988DA831153B5) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$67C1AEAD11992055) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$57CE3992D24BCDF0) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$4FFCD8376704DEC1) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$40A680384110F11C) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$391FF40CC257703E) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$2A586EB86CF558DB) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($06CA6351E003826F) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($142929670A0E6E70) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($27B70A8546D22FFC) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($2E1B21385C26C926) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($4D2C6DFC5AC42AED) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($53380D139D95B3DF) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($650A73548BAF63DE) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($766A0ABB3C77B2A8) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$7E3D36D1B812511A) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$6D8DD37AEB7DCAC5) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$5D40175EB30EFC9C) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$57E599B443BDCFFF) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$3DB4748F2F07686F) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$3893AE5CF9AB41D0) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$2E6D17E62910ADE8) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$2966F9DBAA9A56F0) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$0BF1CA7AA88EDFD6) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($106AA07032BBD1B8) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($19A4C116B8D2D0C8) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($1E376C085141AB53) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($2748774CDF8EEB99) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($34B0BCB5E19B48A8) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($391C0CB3C5C95A63) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($4ED8AA4AE3418ACB) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($5B9CCA4F7763E373) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($682E6FF3D6B2B8A3) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($748F82EE5DEFB2FC) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($78A5636F43172F60) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$7B3787EB5E0F548E) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$7338FDF7E59BC614) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$6F410005DC9CE1D8) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$5BAF9314217D4217) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$41065C084D3986EB) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$398E870D1C8DACD5) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$35D8C13115D99E64) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$2E794738DE3F3DF9) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64(-$15258229321F14E2) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64(-$0A82B08011912E88) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($06F067AA72176FBA) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($0A637DC5A2C898A6) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($113F9804BEF90DAE) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($1B710B35131C471B) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($28DB77F523047D84) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($32CAAB7B40C72493) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($3C9EBE0A15C9BEBC) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($431D67C49C100D4C) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($4CC5D4BECB3E42B6) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($597F299CFC657E2A) { </UtoS_Cnvt> } ,
    { <UtoS_Cnvt> } uint64($5FCB6FAB3AD6FAEC) { </UtoS_Cnvt> } , { <UtoS_Cnvt> } uint64($6C44198C4A475817) { </UtoS_Cnvt> } );
{$ENDIF}
...
function SHA_StylePadding_128_in_1024(Lo64MessageLengthInBits, Hi64MessageLengthInBits: uint64; var Pad): integer;
...
procedure SHA256_Step1(const M: TSHA256_M_Array; var W: TSHA256_W_Array);
var
  t: integer;
  Temp32: uint32;
begin
  ...
  for t := 16 to 63 do
    begin
      Temp32 := LittleSigma1_256_32(W[t - 2]) + W[t - 7] + LittleSigma0_256_32(W[t - 15]) + W[t - 16];
      W[t] := Temp32
    end
end;

procedure SHA512_Step1(const M: TSHA512_M_Array; var W: TSHA512_W_Array);
var
  t: integer;
  Temp64: uint64;
begin
  ...
  for t := 16 to 79 do
    begin
      Temp64 := LittleSigma1_512_64(W[t - 2]) + W[t - 7] + LittleSigma0_512_64(W[t - 15]) + W[t - 16];
      W[t] := Temp64
    end
end;

procedure SHA256_Step3(var aa: TaToh_Array32; const W: TSHA256_W_Array);
var
  T1, T2: uint32;
  t: integer;
begin
...
procedure SHA512_Step3(var aa: TaToh_Array64; const W: TSHA512_W_Array);
var
  T1, T2: uint64;
  t: integer;
begin
...
procedure SHA256_Step4(var HH: TaToh_Array32; const aa: TaToh_Array32);
var
  Letter: TaToh;
begin
...
procedure SHA512_Step4(var HH: TaToh_Array64; const aa: TaToh_Array64);
var
  Letter: TaToh;
begin
  for Letter := a to h do
...
procedure SHA256_Step2(var aa: TaToh_Array32; const HH: TaToh_Array32);
var
  Letter: TaToh;
begin
  for Letter := a to h do
...
procedure SHA512_Step2(var aa: TaToh_Array64; const HH: TaToh_Array64);
var
  Letter: TaToh;
begin
  for Letter := a to h do
...
begin
  result := 'http://csrc.nist.gov/publications/drafts/' + 'fips180-4/Draft-FIPS180-4_Feb2011.pdf'
end;

const
  DigestSizes: array [TSHA2FamilyMember] of integer = (
...
const
  Names: array [TSHA2FamilyMember] of string = (
    // SHA_224, SHA_256, SHA_384, SHA_512, SHA_512_224, SHA_512_256
...
const
  classes: array [TSHA2FamilyMember] of TSHA2_BaseHasherClass = (TSHA224, TSHA256, TSHA384, TSHA512, TSHA512_224, TSHA512_256);
begin
...
const
  Names: array [TSHA2FamilyMember] of string = (
    ...
    SHA224_ProgId, SHA256_ProgId, SHA384_ProgId, SHA512_ProgId, SHA512_224_ProgId, SHA512_256_ProgId);
begin
...
const
  Sizes: array [TSHA2FamilyMember] of integer = (
    // SHA_224, SHA_256, SHA_384, SHA_512, SHA_512_224, SHA_512_256
...
begin
  result := AnsiBytesOf('BA7816BF 8F01CFEA ' + '414140DE 5DAE2223 B00361A3 96177A9C B410FF61 F20015AD')
end;
...
begin
  ...
  PaddingCountInBytes := SHA_StylePadding_128_in_1024(Lo64MessageLengthInBits, Hi64MessageLengthInBits, Pad);
  PadOrigin := 0;
  Xfer := 128 - L;
  if Xfer < 0 then
    Xfer := 0;
...
begin
  result := AnsiBytesOf('DDAF35A1 93617ABA CC417349 AE204131 ' + '12E6FA4E 89A97EA2 0A9EEEE6 4B55D39A 2192992A 274FC1A8 ' +
...
begin
  result := AnsiBytesOf('09330C33 F71147E8 3D192FC7 82CD1B47 53111B17 3B3B05D2 ' +
...
begin
  result := AnsiBytesOf('3928E184 FB8690F8 40DA3988 121D31BE 65CB9D3E F83EE614 ' + '6FEAC861 E19B563A');
end;
