...
resourcestring
  ...
  ES_CannotAssignHuge_BecauseSourceTooBig = 'Cannot assign THugeCardinal because source is too big' + ' and resizing is not allowed.';
  ...
  ES_EratosthenesSievSizeTooSmall = 'EratosthenesSieveSize value (%d) too small for required number of ' +
  ...
  AS_BlockToStream_EndEncrypt_InternalMarshalling = 'TNoncibleEncryptor.End_Encrypt - Internal marshalling error.';
  AS_BlockToStream_EndDecrypt_InternalMarshalling = 'TNoncibleDecryptor.End_Encrypt - Internal marshalling error.';

  AS_BlockPaddingCorrupt = 'Invalid ciphertext - block padding is corrupted.';

  // SmartInspect
{$IFDEF SI}; SIS_Hello = 'Hello';
{$ENDIF}
