...
type
  ...
  protected
    ...
    constructor BaseCreate(Key1: TSymetricKey; // Will be referenced, not cloned.
  ...
  TChainingFeature = (cfNoNounce, // The chaining mode does not require any nounce nor
  ...
  TSymetricEncryptionOption = (optUseGivenIV, // Use the given IV instead of generating one.
...
constructor TBlockChainLink.BaseCreate(Key1: TSymetricKey; IV1: TMemoryStream; Cipher1: IBlockCodec);
begin
  FKey := Key1; // Not owned
...
type
  TBlockChainLinkClass = class of TBlockChainLink;
